...
C {/home/designer/shared/GRO-TDC/std_cells/XOR.sym} 240 -610 0 0 {name=x1}
C {/home/designer/shared/GRO-TDC/std_cells/XOR.sym} 440 -630 0 0 {name=x5}
C {/home/designer/shared/GRO-TDC/std_cells/OR.sym} 460 -370 0 0 {name=x6}
C {/home/designer/shared/GRO-TDC/std_cells/OR.sym} 630 -50 0 0 {name=x7}
...
C {/home/designer/shared/GRO-TDC/std_cells/AND.sym} 270 -430 0 0 {name=x2}
C {lab_wire.sym} 330 -410 0 1 {name=p16 lab=VDD}
C {lab_wire.sym} 330 -250 0 1 {name=p17 lab=VSS}
C {/home/designer/shared/GRO-TDC/std_cells/AND.sym} 270 -250 0 0 {name=x3}
C {lab_wire.sym} 330 -230 0 1 {name=p18 lab=VDD}
C {lab_wire.sym} 330 -70 0 1 {name=p19 lab=VSS}
C {/home/designer/shared/GRO-TDC/std_cells/AND.sym} 270 -70 0 0 {name=x4}
