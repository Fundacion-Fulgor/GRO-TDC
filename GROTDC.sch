...
N 2760 -500 2780 -500 {lab=DRV_RESET}
...
N 2740 -280 2780 -280 {lab=DECLK2}
...
N 2280 -1000 2320 -1000 {lab=OUT}
N 2740 -320 2780 -320 {lab=COUT2,S2[6:0]}
N 2490 -940 2530 -940 {lab=DRV_START}
N 2490 -900 2530 -900 {lab=DRV_STOP}
...
N 3390 -620 3390 -590 {lab=VDD}
N 3480 -400 3520 -400 {lab=MUX_ADDER}
N 3250 -540 3300 -540 {lab=ADDER[0]}
N 3250 -500 3300 -500 {lab=ADDER[1]}
N 3250 -460 3300 -460 {lab=ADDER[2]}
N 3250 -420 3300 -420 {lab=ADDER[3]}
N 3250 -380 3300 -380 {lab=ADDER[4]}
N 3250 -340 3300 -340 {lab=ADDER[5]}
N 3250 -300 3300 -300 {lab=ADDER[6]}
N 3250 -260 3300 -260 {lab=ADDER[7]}
N 3350 -180 3350 -160 {lab=VSS}
N 1920 -880 1960 -880 {lab=CTRL[2:0]}
N 2020 90 2020 110 {lab=VSS}
N 2020 -110 2020 -90 {lab=VDD}
N 1830 -40 1870 -40 {lab=START}
N 1830 -20 1870 -20 {lab=STOP}
N 1830 0 1870 0 {lab=RESET}
N 1820 20 1870 20 {lab=MUX_ADDER}
N 2170 -40 2210 -40 {lab=DRV_START}
N 2170 -20 2210 -20 {lab=DRV_STOP}
N 2170 0 2210 0 {lab=DRV_RESET}
N 2170 20 2220 20 {lab=OUT}
N 3390 -180 3390 -120 {lab=DRV_CTRL[2:0]}
N 2170 40 2220 40 {lab=DRV_CTRL[2:0]}
N 1820 40 1870 40 {lab=CTRL[2:0]}
N 2930 50 2930 70 {lab=VSS}
N 2930 -90 2930 -70 {lab=VDD}
N 2740 -10 2780 -10 {lab=DRV_STOP}
N 3080 -20 3120 -20 {lab=DECLK}
N 3080 0 3120 0 {lab=DECLK2}
C {/foss/designs/GRO-TDC/std_cells/Counters_6bits.sym} 2240 -400 0 0 {name=x5
}
C {/foss/designs/GRO-TDC/std_cells/Counters_regs_6bits.sym} 2680 -370 0 0 {name=x6
}
C {/foss/designs/GRO-TDC/std_cells/Counter_FA_6bits.sym} 1880 -190 0 0 {name=x7
}
C {/foss/designs/GRO-TDC/std_cells/Counter_FA_7bits.sym} 2080 -110 0 0 {name=x8
}
...
C {lab_wire.sym} 2760 -500 3 0 {name=p22 sig_type=std_logic lab=DRV_RESET
}
...
C {lab_wire.sym} 2740 -280 3 0 {name=p34 sig_type=std_logic lab=DECLK2
}
C {lab_wire.sym} 2760 -240 3 0 {name=p38 sig_type=std_logic lab=RESET
}
C {/foss/designs/GRO-TDC/std_cells/Counters__FA_regs_7bits.sym} 2740 -160 0 0 {name=x9
}
...
C {opin.sym} 2280 -1000 0 1 {name=p48 lab=OUT}
...
C {/foss/designs/GRO-TDC/std_cells/SR_Latch.sym} 2510 -830 0 0 {name=x1}
...
C {lab_wire.sym} 2490 -900 0 0 {name=p5 sig_type=std_logic lab=DRV_STOP
}
...
C {lab_wire.sym} 3390 -620 0 0 {name=p59 sig_type=std_logic lab=VDD
}
C {lab_wire.sym} 3250 -540 0 0 {name=p60 sig_type=std_logic lab=ADDER[0]
}
C {lab_wire.sym} 3250 -500 0 0 {name=p61 sig_type=std_logic lab=ADDER[1]
}
C {lab_wire.sym} 3250 -460 0 0 {name=p62 sig_type=std_logic lab=ADDER[2]
}
C {lab_wire.sym} 3250 -420 0 0 {name=p63 sig_type=std_logic lab=ADDER[3]
}
C {lab_wire.sym} 3250 -380 0 0 {name=p64 sig_type=std_logic lab=ADDER[4]
}
C {lab_wire.sym} 3250 -340 0 0 {name=p65 sig_type=std_logic lab=ADDER[5]
}
C {lab_wire.sym} 3250 -300 0 0 {name=p66 sig_type=std_logic lab=ADDER[6]
}
C {lab_wire.sym} 3250 -260 0 0 {name=p67 sig_type=std_logic lab=ADDER[7]
}
C {lab_wire.sym} 3520 -400 0 1 {name=p68 sig_type=std_logic lab=MUX_ADDER
}
C {lab_wire.sym} 3350 -160 0 0 {name=p69 sig_type=std_logic lab=VSS
}
C {/foss/designs/GRO-TDC/std_cells/MUX_8_1.sym} 3180 -330 0 0 {name=x4}
C {ipin.sym} 1920 -880 0 0 {name=p70 lab=CTRL[2:0]}
C {lab_wire.sym} 2020 110 0 0 {name=p71 sig_type=std_logic lab=VSS
}
C {lab_wire.sym} 2020 -110 0 0 {name=p72 sig_type=std_logic lab=VDD
}
C {lab_wire.sym} 1830 -40 0 0 {name=p73 sig_type=std_logic lab=START
}
C {lab_wire.sym} 1830 -20 0 0 {name=p74 sig_type=std_logic lab=STOP
}
C {lab_wire.sym} 1830 0 0 0 {name=p75 sig_type=std_logic lab=RESET
}
C {lab_wire.sym} 1820 20 0 0 {name=p76 sig_type=std_logic lab=MUX_ADDER
}
C {lab_wire.sym} 2210 -40 0 1 {name=p84 sig_type=std_logic lab=DRV_START
}
C {lab_wire.sym} 2210 -20 0 1 {name=p85 sig_type=std_logic lab=DRV_STOP
}
C {lab_wire.sym} 2210 0 0 1 {name=p86 sig_type=std_logic lab=DRV_RESET
}
C {lab_wire.sym} 2220 20 0 1 {name=p87 sig_type=std_logic lab=OUT
}
C {/foss/designs/GRO-TDC/Buffers_IO.sym} 2020 0 0 0 {name=x10}
...
C {/foss/designs/GRO-TDC/Delay_cell.sym} 2930 -10 0 0 {name=x11}
...
C {lab_wire.sym} 2740 -10 0 0 {name=p81 sig_type=std_logic lab=DRV_STOP
}
C {lab_wire.sym} 3120 -20 0 1 {name=p82 sig_type=std_logic lab=DECLK
}
C {lab_wire.sym} 3120 0 0 1 {name=p83 sig_type=std_logic lab=DECLK2
}
