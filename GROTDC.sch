...
N 3250 -380 3300 -380 {lab=ADDER[0]}
N 3250 -340 3300 -340 {lab=ADDER[1]}
N 3250 -300 3300 -300 {lab=ADDER[2]}
N 3250 -260 3300 -260 {lab=ADDER[3]}
N 3350 -180 3350 -160 {lab=VSS}
N 1920 -840 1960 -840 {lab=DECLK}
...
C {lab_wire.sym} 3520 -400 0 1 {name=p68 sig_type=std_logic lab=OUT
}
...
C {ipin.sym} 1920 -840 0 0 {name=p70 lab=CTRL[2:0]}
