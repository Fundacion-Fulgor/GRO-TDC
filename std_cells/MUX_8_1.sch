...
N 250 -490 250 -450 {lab=VS[1:0]}
N 230 -490 230 -450 {lab=VS[1]}
N 160 -70 160 -30 {lab=VSS}
N 250 -70 250 -30 {lab=VS[1:0]}
N 230 -70 230 -30 {lab=VS[1]}
...
C {/foss/designs/PhaseInterpolator/Custom_std_cells/MUX_2_1.sym} 560 -320 0 0 {name=x7}
...
C {ipin.sym} 110 -370 0 0 {name=p41 lab=VS[2:0]}
...
C {lab_wire.sym} 250 -450 2 0 {name=p48 sig_type=std_logic lab=VS[1:0]}
C {lab_wire.sym} 230 -450 2 1 {name=p49 sig_type=std_logic lab=VS[1]}
...
C {lab_wire.sym} 250 -30 2 0 {name=p2 sig_type=std_logic lab=VS[1:0]}
C {lab_wire.sym} 230 -30 2 1 {name=p3 sig_type=std_logic lab=VS[1]}
C {lab_wire.sym} 600 -310 2 1 {name=p4 sig_type=std_logic lab=VSS}
C {lab_wire.sym} 640 -310 2 1 {name=p6 sig_type=std_logic lab=VS[2]}
